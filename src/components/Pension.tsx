      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <ul className="space-y-4 pt-4">
               <li className="flex items-center gap-3">
                  ...
                  <span className="font-semibold">Guaranteed up to 15.00% p.a. returns</span>
               </li>
               <li className="flex items-center gap-3">
                  <Shield className="h-5 w-5 text-accent" />
                  <span className="font-semibold">Zero market risk on your principal</span>
               </li>
            </ul>

            <div className="pt-6">
                  <Button className="w-full sm:w-auto bg-cyan-gradient text-[#0B1120] hover:opacity-90 font-bold border-0 mt-8 shadow-lg shadow-primary/20">
          ...
          >
            ...
            <Card className="bg-white/90 dark:bg-[#0F172A]/90 text-slate-800 dark:text-white backdrop-blur-md shadow-2xl overflow-hidden relative z-10 border border-slate-200 dark:border-0">
              <div className="flex flex-col sm:flex-row">
                ...
                <CardContent className="p-8 sm:w-2/3">
                  <h3 className="text-lg font-bold mb-6 text-center text-slate-800 dark:text-white">Monthly Income Illustration</h3>
                  
                  <div className="flex flex-col items-center justify-center space-y-6">
                    <div className="bg-slate-50 dark:bg-[#0B1120] w-full p-4 rounded-xl border border-slate-200 dark:border-white/10 flex justify-between items-center shadow-inner">
                      <span className="text-sm font-semibold text-slate-500 dark:text-white/60">Lump Sum Deposit</span>
                      <span className="text-xl font-bold text-slate-800 dark:text-white">₹ 15,00,000</span>
                    </div>
                    ...
                    <div className="bg-primary/10 p-6 rounded-xl border border-primary/20 text-center relative overflow-hidden w-full">
                      ...
                      <p className="text-4xl sm:text-5xl font-black text-slate-800 dark:text-white relative z-10">₹ 18,750</p>
                    </div>
                  </div>
